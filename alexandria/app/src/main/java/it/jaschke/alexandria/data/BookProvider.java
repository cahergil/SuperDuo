...
public class BookProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            /**
             * to delete authors from authors table
             */
            case AUTHOR_ID:
                rowsDeleted = db.delete(AlexandriaContract.AuthorEntry.TABLE_NAME,
                                      AlexandriaContract.AuthorEntry._ID + " = " + ContentUris.parseId(uri),
                                      selectionArgs);
                break;
            /**
             * to delete categories from categories table
             */
            case CATEGORY_ID:
                rowsDeleted= db.delete(AlexandriaContract.CategoryEntry.TABLE_NAME,
                                      AlexandriaContract.CategoryEntry._ID + " = " + ContentUris.parseId(uri),
                                      selectionArgs);
                break;
